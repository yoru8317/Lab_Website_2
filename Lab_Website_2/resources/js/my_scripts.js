...
function loadStatsPage(){
	...
	var updatewin = document.getElementById("wins");
	updatewin.innerHTML = win;
	// document.getElementById("wins").innerHTML = wins;

	var updateloses = document.getElementById("losses");
	updateloses.innerHTML = lose;
}
/*
...
function loadPlayersPage(){
	var playersSelect = document.getElementById("player_selector");
	var iterate = "";
	for (var i = 0; i < players.length; i++)
	{
		var name = players[i].name;
		iterate += "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + name +"</a>";
		playersSelect.innerHTML = iterate;
	}
	//playersSelect.innerHTML = iterate;
}
...
function switchPlayers(playerNum)
{
  ...
  var receiving =Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
	document.getElementById("avg_p_yards").innerHTML= pass;
  document.getElementById("avg_r_yards").innerHTML= rushing;
  document.getElementById("avg_rec_yards").innerHTML= receiving;
